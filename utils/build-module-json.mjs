...
template.url = "https://github.com/toastygm/hm-loc-hundholt";
template.bugs = "https://github.com/toastygm/hm-loc-hundholt/issues";
template.manifest =
    "https://github.com/toastygm/hm-loc-hundholt/releases/latest/download/module.json";
template.download = `https://github.com/toastygm/hm-loc-hundholt/releases/download/v${pkg.version}/module.zip`;
